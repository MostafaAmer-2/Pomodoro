...
import static com.dreidev.mostafa.pomodoro.Model.TrelloBoard.parseJSONArrayIntoBoards;
...
public class trelloBoards extends Fragment {
    ...
    public void goToMain() {
        ((BottomNavigatorActivity)getActivity()).loadFragment(new trelloLogin(),true);
    }
